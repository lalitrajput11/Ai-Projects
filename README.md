...
*Real-time Agent Status and Recent Activity*

### Agent Planning & Execution
![Planning](assets/agent_plan.png)
*Autonomous Planning in Action*

### Tool Outputs
![Docker JSON](assets/docker_list_json.png)
*Detailed JSON Outputs from Tools*

### Memory Management
![Memory Viewer](assets/memory_viewer.png)
*Inspect Conversation History and Stored Facts*
